        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                ...
                <ul id="knowledgebase" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                    <li class="sidebar-item {{ 'knowledge' == request()->path() ? 'active' : '' }}"><a class="sidebar-link" href="knowledge">Knowledgebase</a></li>
                    <li class="sidebar-item {{ 'article' == request()->path() ? 'active' : '' }}"><a class="sidebar-link" href="{{ route('article') }}">Articles</a></li>
                    <li class="sidebar-item {{ 'forums' == request()->path() ? 'active' : '' }}"><a class="sidebar-link" href="forums">Forums</a></li>
                    <li class="sidebar-item {{ Request::is('news*') ? 'active' : '' }}"><a class="sidebar-link" href="{{ route('news.usernews')}}">News</a></li>
                </ul>
            </li>

            <li class="sidebar-item {{ 'profile' == request()->path() ? 'active' : '' }}">
                <a class="sidebar-link" href="profile"> 
                <i class="align-middle" data-feather="user"></i> <span class="align-middle">Profile</span>
                </a>
            </li>

            <li class="sidebar-item {{ 'helpcenter' == request()->path() ? 'active' : '' }}">
            ...
            <li class="sidebar-item {{ 'setting' == request()->path() ? 'active' : '' }}">
